...
CREATE TABLE `item_sku` (
  ...
  `sku_itemdetail_guid` tinytext DEFAULT NULL,
  ...
  `sku_varietal` tinytext DEFAULT NULL,
  `sku_region` tinytext DEFAULT NULL,
  ...
  `sku_preswap` text DEFAULT NULL,
  `sku_postswap` text DEFAULT NULL,
  `sku_qty_reserved` int(11) DEFAULT 0,
  `sku_cogs_is_estimated` tinyint(1) NOT NULL DEFAULT 0,
  `sku_taxset_id` tinytext DEFAULT NULL,
  ...
  `sku_supplier_guid` tinytext DEFAULT NULL,
...
CREATE TABLE `new_customer_data_after_bk_from_lcc` (
  `Customer ID` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `Order Count` int(11) DEFAULT NULL,
  `Item Count` int(11) DEFAULT NULL,
...
CREATE TABLE `old_order_data_500k_orders` (
  ...
  `offer_guid` char(36) DEFAULT NULL,
  `offer_title` varchar(100) DEFAULT NULL,
  `offer_price` varchar(4) DEFAULT NULL,
  `offer_meta_title` varchar(132) DEFAULT NULL,
  `offer_subtitle` varchar(243) DEFAULT NULL,
  `offer_primary_varietal` varchar(25) DEFAULT NULL,
...
CREATE TABLE `order_list` (
  ...
  `order_sku_list` mediumtext DEFAULT NULL,
  ...
  `order_user_nth` int(11) DEFAULT NULL,
  ...
  `x_order_is_authorized_or_captured` enum('false','true') DEFAULT NULL,
...
CREATE TABLE `user_list` (
  ...
  `x_total_qty` int(11) DEFAULT NULL,
  ...
  `x_achievement_points` int(11) DEFAULT NULL,
  ...
  `x_order_count` int(11) DEFAULT NULL,
  ...
  `x_cloud_count` int(11) DEFAULT NULL,
